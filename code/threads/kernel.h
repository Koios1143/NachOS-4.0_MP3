...
// they're global variables used everywhere.
    ...
    // [ADD] For checking whether the physical space is in use
    bool physInUse[NumPhysPages];
    // [END-OF-ADD]
  ...
  private:
	...
	Thread* t[10];
	char*   execfile[10];
  int initPriority[10]; // [ADD MP3] record initial priority for argument -ep
	int execfileNum;
	int threadNum;
